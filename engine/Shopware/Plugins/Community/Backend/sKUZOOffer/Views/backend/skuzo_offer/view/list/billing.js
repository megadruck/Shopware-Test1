...
autoScroll:true,
    ...
    createShopField: function() {
        var me = this;
        me.shopStore = Ext.create('Shopware.store.Shop', {
            pageSize: 7
        });
        me.shopStore.load();
    ...
    createShippingTaxField: function() {
        ...
        if(me.offerId !=0){
            ...
            me.filterForm.items.items[10].setValue(me.record.raw.shop.id);
                    ...
                    if (success == true) {
                        Ext.each(records, function (record) {
                            if(record.get('customerId') == me.customerId /*me.customerRecord.get('id')*/){
                               ...
                               me.filterForm.items.items[10].setValue(record.get('shopId'));
