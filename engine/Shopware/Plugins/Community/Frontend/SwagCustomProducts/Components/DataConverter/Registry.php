...
class Registry
{
    ...
    /**
     * @param ConverterInterface[] $converterInterfaces
     */
    public function __construct(array $converterInterfaces)
    {
        $this->converter = $converterInterfaces;
    }
    ...
    {
        if (!isset($this->converter[$name])) {
            return $this->converter[self::DEFAULT_CONVERTER];
        }
