...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', {
        ...
        _initIframeSettings: function (options) {
            ...
            var test = options.url.substring(0, options.url.indexOf('/', 8));
            if (options.redirect && test !== location.protocol + '//' + location.host) {
        ...
        _onSend: function (e, data) {
            var sender =  e.delegateTarget,
                typeData = sender.getAttribute("data-type");

            data.formData = {typeData: typeData};
