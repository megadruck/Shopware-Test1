...
Ext.define('Shopware.apps.Customer.view.address.detail.Address', {
    ...
    snippets: {
        ...
        fields: {
            ...
            setDefaultShippingAddress: '{s name=detail/label/setDefaultShippingAddress}Als Standard-Lieferaddresse benutzen{/s}',
            setDefaultSenderAddress: '{s name=detail/label/setDefaultSenderAddress}Als Standard-Absenderadresse benutzen{/s}'
        }
    },
                ...
                },
                {
                    ...
                    fields: {
                        ...
                        setDefaultSenderAddress: {
                            ...
                            uncheckedValue: false,
                            inputValue: true,
                            boxLabel: me.snippets.fields.setDefaultSenderAddress,
                            fieldLabel: null,
                            labelWidth: 155,
                            anchor: '95%'
