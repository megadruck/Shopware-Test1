...
Ext.define('Shopware.apps.Customer.view.address.List', {
    ...
    defaultColumnRenderer: function (value, col, record) {
        ...
        if (customer && parseInt(customer.raw.default_sender_address_id) == record.get('id')) {
            defaults.push('Absendeadresse');
        }
    ...
    requestSenderData: function(customerId, requestUrl, defaults) {
        var me = this;
