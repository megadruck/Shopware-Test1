...
{block name="frontend_account_profile_profile_panel"}
    <div class="account--box panel has--border is--rounded">

        {block name="frontend_account_profile_profile_title"}
            <h2 class="panel--title is--underline">{s name="ProfileHeadline"}{/s}</h2>
        {/block}
...
{block name="frontend_account_profile_email_panel"}
    ...
    {block name="frontend_account_profile_email_title"}
        <h2 class="panel--title is--underline">{s name="EmailHeadline"}{/s}</h2>
    {/block}
...
<div class="account--box panel has--border is--rounded">
    ...
    <h2 class="panel--title is--underline">{s name="PasswordHeadline"}{/s}</h2>
    {/block}
